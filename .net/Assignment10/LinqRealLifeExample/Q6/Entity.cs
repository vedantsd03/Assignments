       ...
       static void Main(string[] args)
        {
            ...
            //using LINQ
            var result = from i in itemsInStock where i.Name.Contains("s") orderby i.Name descending select i;
            ...
            //using Lamda
            var res = (itemsInStock.Where(i=>i.Name.Contains("s")).OrderBy(i=>i.Name).Select(i=>i)).Reverse();
