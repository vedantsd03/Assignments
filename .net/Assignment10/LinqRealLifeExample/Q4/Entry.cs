       ...
       static void Main(string[] args)
        {
            ...
            //using LINQ
            var result = from i in itemsInStock where i.NumberInStock==100 select new { i.Name, i.Description };
            ...
            //using Lamda
            var res = itemsInStock.Where(i=>i.NumberInStock==100).Select( i => new { i.Name,i.Description });
